                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <ul class="list-group list-group-unbordered mb-3">
                                        ...
                                        <li class="list-group-item">
                                            <b>Nama</b> <a class="float-right"><?= $editUser['nama_gh']; ?></a>
                                        </li>
                                        <li class="list-group-item">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="lokasi" class="col-sm-2 col-form-label">Role Id</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lokasi" name="role_id" value="<?= $editUser['role_id']; ?>">
                                        <?= form_error('lokasi', '<small class="text-danger pl-3">', '</small>'); ?>

                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lokasi" class="col-sm-2 col-form-label">Aktif</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="lokasi" name="is_active" value="<?= $editUser['is_active']; ?>">
                                        <?= form_error('lokasi', '<small class="text-danger pl-3">', '</small>'); ?>
